export default {
  ...
  setPurchaseOrderProductsConfirm: async (purchaseOrderId) => {
    const value = purchaseOrderId ? purchaseOrderId : OrdersTable.triggeredRow.Id;
    ...
    if (products && products.length > 0) {
      for (const p of products) {
        ...
        const productStockLocation = {
          Id: OrdersTable.triggeredRow.WarehouseId,
          WarehouseName: OrdersTable.triggeredRow.Warehouse,
          Stock: p.quantity,
        }
